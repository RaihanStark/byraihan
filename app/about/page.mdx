...
export const metadata = {
  title: 'About — Raihan Yudo Saputra',
  description: 'About Raihan Yudo Saputra — a passionate software engineer with a strong focus on building scalable and efficient systems.',
}
